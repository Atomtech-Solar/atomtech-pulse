  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto pt-0">
        ...
        <div className="relative mb-8 h-[340px] sm:h-[400px] md:h-[480px] lg:h-[500px]">
          ...
          <img
            src={robotImage}
            alt="Robô TOP UP"
            className="absolute z-20 left-1/2 -translate-x-1/2 w-[280px] sm:w-[360px] md:w-[600px] lg:w-[520px] xl:w-[800px] h-[320px] sm:h-[380px] md:h-[460px] lg:h-[500px] align-top object-contain drop-shadow-[0_0_30px_rgba(255,77,0,0.35)]"
          />
        </div>
        ...
        <Button
          asChild
          size="lg"
          className="text-base px-10 h-12 rounded-full btn-energy-primary hover-glow-energy mt-8 sm:mt-10 md:mt-12"
        >
